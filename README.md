[README.md](https://github.com/user-attachments/files/28237498/README.md)
...
🎥 [CBIO313 Project Presentation](https://nileuniversity-my.sharepoint.com/:f:/g/personal/a_mohamed2202_nu_edu_eg/IgDLQOq9LD4dRZOey7_oSiKVAbx-RdvBR_zw9GvireuBumI?e=lqgGIF)

> The video covers: data preprocessing, model training, evaluation results, and key findings.

### 🔹 CBIO313 Project PDF

📊 [CBIO313 Project PDF](diabetes_presentation_final.pdf)

> Contains all models, performance metrics, and key visuals.
...
├── diabetes_presentation_final.pdf  # CBIO313 Project PDF
└── README.md
```
